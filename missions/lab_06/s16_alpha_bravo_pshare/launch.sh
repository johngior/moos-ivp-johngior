...
#----------------------------------------------------------
echo "Launching $COMMUNITY_1 MOOS Community with WARP:" $TIME_WARP
pAntler $COMMUNITY_1.moos --MOOSTimeWarp=$TIME_WARP >& /dev/null &

echo "Launching $COMMUNITY_2 MOOS Community with WARP:" $TIME_WARP
pAntler $COMMUNITY_2.moos --MOOSTimeWarp=$TIME_WARP >& /dev/null &

echo "Launching $COMMUNITY_3 MOOS Community with WARP:" $TIME_WARP
